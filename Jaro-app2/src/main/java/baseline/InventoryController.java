...
public class InventoryController {
    ...
    @FXML
    public TableView<Inventory> itemTable;
    @FXML
    public TableColumn<Inventory, Double> valueDisplay;
    @FXML
    public TableColumn<Inventory, String> serialDisplay;
    @FXML
    public TableColumn<Inventory, String> nameDisplay;
    @FXML
    ...
    public void initialize() {
        ...
        nameDisplay.prefWidthProperty().bind(itemTable.widthProperty().
                subtract(valueDisplay.widthProperty().add(serialDisplay.widthProperty().add(2))));
        ...
        valueDisplay.setCellFactory(tableColumn -> new TableCell<Inventory, Double>() {
            @Override
        ...
        FilteredList<Inventory> filteredList = new FilteredList<>(inventoryModel.getItem(), p-> true);
        searchField.textProperty().addListener(((observable, oldValue, newValue) -> {
            filteredList.setPredicate(inventoryItem -> {
                ...
                if (inventoryItem.getName().toLowerCase().contains(lowerCaseFilter)) {
                    return true;
                } else if (inventoryItem.getSerial().toLowerCase().contains(lowerCaseFilter)) {
                    return true;
                }
                return false;
            });
    ...
    public void removeItem(int currentIndex) {
        inventoryModel.getItem().remove(currentIndex);
    }
